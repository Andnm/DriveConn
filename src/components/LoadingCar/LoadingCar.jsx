                ...
                <svg className="car" width="102" height="40" xmlns="http://www.w3.org/2000/svg">
                    <g transform="translate(2 1)" stroke="#0077b6" fill="none" fillRule="evenodd" strokeLinecap="round"
                        ...
                        <path className="car__body"
                            ...
                            strokeWidth="3" />
                        <ellipse className="car__wheel--left" strokeWidth="3.2" fill="#0077b6" cx="83.493" cy="30.25" rx="6.922"
                            ry="6.808" />
                        <ellipse className="car__wheel--right" strokeWidth="3.2" fill="#0077b6" cx="46.511" cy="30.25" rx="6.922"
                            ry="6.808" />
